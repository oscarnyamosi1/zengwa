        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              Founded in 2019 in the heart of Coast  region of Kenya, we have grown from serving 45 children to over 84 students across 3 schools — with plans to reach 2,000 by 2028.
            </p>
